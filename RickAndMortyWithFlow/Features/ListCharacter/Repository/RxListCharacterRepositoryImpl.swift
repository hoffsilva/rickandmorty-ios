//
//  RxListCharacterRepositoryImpl.swift
...
class RxListCharacterRepositoryImpl: RxListCharacterRepository {
    
    let service: RxListCharacterService
    
    init(service: RxListCharacterService) {
